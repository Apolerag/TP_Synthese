...
ifeq ($(config),debug)
  OBJDIR     = obj/debug/ray_tutorial1
  TARGETDIR  = .
  TARGET     = $(TARGETDIR)/ray_tutorial1
...
ifeq ($(config),release)
  OBJDIR     = obj/release/ray_tutorial1
  TARGETDIR  = .
  TARGET     = $(TARGETDIR)/ray_tutorial1
...
$(OBJDIR)/ray_tutorial1.o: ray_tutorial1.cpp
	@echo $(notdir $<)
	$(SILENT) $(CXX) $(ALL_CXXFLAGS) $(FORCE_INCLUDE) -o "$@" -MF $(@:%.o=%.d) -c "$<"
